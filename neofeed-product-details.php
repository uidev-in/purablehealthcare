                        ...
                        <div class="col-xl-5">
                            <div class="product-details mb-30">
                                ...
                                <ul style="line-height:28px;">
                                    <li><i class="fas fa-check text-success mr-2"></i>Malabsorptive Conditions</li>
                                    <li><i class="fas fa-check text-success mr-2"></i>Lactose Intolerance</li>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="id-desc" role="tabpanel" aria-labelledby="desc-tab">
                                    ...
                                    <ul style="line-height:28px;">
                                        ...
                                        <li>» Neofeed is free from gulten and lactose</li>
